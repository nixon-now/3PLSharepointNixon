    ...
    layout
    {
        area(Content)
        {
            ...
            group("File Settings")
            {
                ...
                // only obsolete FindShipFileForOrder / BuildExpectedFileName reference it
        ...
        area(Processing)
        {
            group(Endpoints)
            {
                ...
                action(RefreshToken)
                {
                    ...
                    begin
                        if Confirm('Are you sure you want to refresh the SharePoint access token?') then begin
