...
# ====================== CONFIGURATION ======================
$TransferDirection = "FTPToSP"  # Changed to FTPToSP for EU
...
# FTP/SFTP Settings
$Protocol               = "FTP"
$FtpHost                = "mystock.fms-ea.com"
$FtpPort                = 21
$FtpUser                = "nixon"
$FtpPass                = "9tfyhNVB!"
$FtpSourceFolder        = "/OUT"           # Files will be downloaded from here
$FtpArchiveFolder       = "/archive"       # Files will be moved here after download
$FtpTargetFolder        = "/IN"            # Not used for FTPToSP direction
